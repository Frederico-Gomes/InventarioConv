...
namespace InventarioConv.Tests
{
    public class ProdutoTest
    {
        ...
        public void BuscaProduto()
        {
            ...
            Produto coca = new Produto { ID = Guid.Parse("c1ce3a61-33b7-42bb-b0b0-b11b2b8ec65f"), Nome = "Coca-Cola Lata", Descricao = "Regrigerante 350ml", Quantidade = 40, Tipo = Borders.Enum.TipoEnum.Alimenticios };
